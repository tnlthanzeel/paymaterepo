...
<body style="background-image: url(assets/img/adminlogged.png);">
    <form id="form1" runat="server">
        ...
        <div style="text-align: center;">
            <asp:Label ID="norecord" runat="server" Text="No Records Found " Font-Bold="true" ForeColor="red"></asp:Label>
            <asp:Label ID="blocked" runat="server" Text="User Blocked Successfully" Font-Bold="true" ForeColor="#009933"></asp:Label>
