			...
			<div class="container">
				<div class="row">
					<div class="col-sm-8 col-sm-offset-2 text">
						<br />
						<br />
						<div style="align-content:center;font-size:larger;color:darkgray" class="  btn btn-default">
							<a href="publicabout.aspx" style="color:blueviolet;">About</a>
							</div>
						<br />
						<br />
						<br />
						...
						<div class="form-bottom">
							<form role="form" method="post" class="login-form" runat="server">
								...
								<div style="text-align: center">
									<asp:Label ID="loginerror" runat="server" Text="Incorrect user name or password " ForeColor="red"></asp:Label>
								...
								<table>
									<tr>
										...
										<td class="auto-style1">
											<asp:Button ID="btnlog" runat="server" Text="Sign in" CssClass="btn btn-success" Width="212px" OnClick="btnlog_Click" /></td>
										<td><a href="register.aspx">
											<input type="button" value="Register" class="btn btn-primary" style="width: 229px" /></a></td>
									</tr>
								</table>
							</form>
						</div>
